...
(NULL,17,'贵 从来不是它的缺点 是你的缺点breo 倍轻松 迷你脸部按摩器 M319','按摩器材','breo 倍轻松 迷你脸部按摩器 M319','89','105','1000',true,'5000','接受预定(备货时间依据当前货源情况而定)','型号:',NULL,1570636751000,4,'/details?lid=17','http://127.0.0.1:5050/img/details/lunbotu/16.1.jpg','输入蛋券sw07,满1000-30元'),
(NULL,18,'Goldlion 金利来 男士皮带 经典时尚牛皮自动扣皮带腰带男裤带 GBA6003-51-5 黑色','皮带/礼盒','Goldlion 金利来 男士皮带 经典时尚牛皮自动扣皮带腰带男裤带 GBA6003-51-5 黑色','129','150','1000',true,'5000','有货',NULL,NULL,1570636751000,4,'/details?lid=18','http://127.0.0.1:5050/img/details/lunbotu/17.1.jpg','输入蛋券sj07,满1000-30元'),
(NULL,19,'GUESS美国盖尔斯 新款时尚欧美字母印花女士手包小号手拿包手抓包晚宴包化妆包多功能包 粉色','手提单肩包','GUESS美国盖尔斯 新款时尚欧美字母印花女士手包小号手拿包手抓包晚宴包化妆包多功能包 粉色','99','120','1000',true,'5000','有货','颜色:',NULL,1570636751000,4,'/details?lid=19','http://127.0.0.1:5050/img/details/lunbotu/18.1.jpg',NULL),
(NULL,20,'EDIFIER 漫步者 B3 高素质的电视音响 家庭影院 无线蓝牙回音壁 千元内杀手级全功能SOUNDBAR','音箱','EDIFIER 漫步者 B3 高素质的电视音响 家庭影院 无线蓝牙回音壁 千元内杀手级全功能SOUNDBAR','699','750','1000',true,'5000','接受预定(需2－3个工作日备货)','系列:',NULL,1570636751000,4,'/details?lid=20','http://127.0.0.1:5050/img/details/lunbotu/19.1.jpg','输入蛋券sj07,满1000-30元'),
(NULL,21,'WD 西部数据 红盘 2TB NAS专用硬盘 WD20EFRX - 3.5英寸 5400-7200转 SATAIII(6.0Gb/s) 64MB','硬盘','WD 西部数据 红盘 2TB NAS专用硬盘 WD20EFRX - 3.5英寸 5400-7200转 SATAIII(6.0Gb/s) 64MB','599','710','1000',true,'5000','接受预定(备货时间依据当前货源情况而定)','容量:',NULL,1570636751000,4,'/details?lid=21','http://127.0.0.1:5050/img/details/lunbotu/20.1.jpg','输入蛋券sj07,满1000-30元');
